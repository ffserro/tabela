...
def troca_update():
    st.session_state.troca = st.session_state.conn.read(worksheet='TROCA', ttl=0)
    return st.session_state.troca

def licpag_update():
    st.session_state.licpag = st.session_state.conn.read(worksheet='LICPAG', ttl=0)
...
def efetivo_update():
    st.session_state.efetivo = st.session_state.conn.read(worksheet='EMB', ttl=0)
...
def restrito_update():
    st.session_state.restrito = st.session_state.conn.read(worksheet='REST', ttl=0)
